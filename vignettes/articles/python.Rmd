...
As with the R package, the Python module has a function `mean_arterial_pressure` to simplify the
...
py_card = phx.phoenix_cardiovascular(
    ...
    age = sepsis["age"],
    mean_arterial_pressure = phx.mean_arterial_pressure(sepsis["sbp"], sepsis["dbp"])
)
print(type(py_card))
print(py_card)
```
