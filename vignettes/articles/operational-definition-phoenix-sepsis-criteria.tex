...
\citet{schlapbach_2024_international} along with several alternatives.  The different
...
\citep{sanchezpinto_2024_development,schlapbach_2024_international} we used:
\begin{itemize}
  \item $T = [0, 1440)$
  \item Look backs:
    \begin{itemize}
...
\begin{equation}
  Neuro_{Alt3}(T; m_{gcs}, m_{pupil}) := \min\left(2, 
