...
\begin{equation}
  \label{eq:coag}
  % R: phoenix_coagulation()
  \DS{Coag}[\m{coag}] \coloneqq \min \left\{2, \sum_{x \in \boldsymbol{C}_{\mathrm{coag}}} \DS*{x}[\m{coag}] \right\},
\end{equation}
where
\begin{equation}
  \label{eq:coag-component-set}
  \boldsymbol{C}_{\mathrm{coag}} \coloneqq \left\{\mathrm{Platelets}, \mathrm{INR}, \mathrm{DDimer}, \mathrm{Fibrinogen}\right\}.
\end{equation}
...
and alanine aminotransferase (ALT) reported in units of IU/L, Table~\ref{tab:hepatic-ehr}.
...
\begin{equation}
  ...
  \Bigg[
    ...
    \sum_{x \in \boldsymbol{C}_{\mathrm{card}}} \max_{t \in T} \DS*{x}
  \Bigg],
\end{equation}
where
\begin{equation}
  \label{eq:card-component-set}
  \boldsymbol{C}_{\mathrm{card}} \coloneqq \left\{\mathrm{Vasos}, \mathrm{MAP}, \mathrm{Lactate}\right\}.
\end{equation}
...
\begin{equation}
  ...
  \mathbb{I} \left\{ \sum_{x \in \boldsymbol{C}_{\mathrm{card}}}\max_{t \in T} \DS*{x} \geq \kappa\right\}
\end{equation}
for $\sigma \geq \kappa > 0.$
...
\begin{multline}
  ...
  \ODSS{d}[FCD] \coloneqq \\
    \shoveleft{ \quad \quad
      ...
      \min \left\{ 2, \sum_{x \in \boldsymbol{C}_{\mathrm{coag}}} \max_{t \in T} \DS*{x}[\boldsymbol{m}]\right\}
      + \sum_{x \in \omega_{d}} \max_{t \in T} \DS*{x}
    \Bigg],
\end{multline}
where
