...
\subsubsection{Respiratory Organ Dysfunction Score}\label{resp-odss}
...
Importantly: The ODSS is a convince and has not been evaluated in the absence of
suspected infection, that is The development of PSS only investigated ODSS in
the presence of suspected infection~\citep{sanchezpinto_2024_development}.
\begin{equation}
  \label{eq:odss}
