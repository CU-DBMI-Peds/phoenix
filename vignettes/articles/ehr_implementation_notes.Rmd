...
Python module, along with the example SQL code, assume that the data have been
...
* Age less than 0 months or greater than or equal to 216 months at encounter start

## Data cleaning and preparation

* Verify all variables are in the expected units; convert as necessary. E.g. age in months; lactate in mmol/L, etc.
* As appropriate replace invalid values with NULL; e.g. if age in months is outside [0, 216), consider whether the patient should be scored at all.
* No imputation for NULL/invalid values
* Last observation carry-forward within the appropriate window for each variable; the maximum carry-forward is 24 hours.
...
* Use the last known good value when calling Phoenix functions.
...
easily looking backward in time within an encounter.  When applying the
...
* Age greater than or equal to 0 months and less than 216 months at encounter start
* Suspected infection
