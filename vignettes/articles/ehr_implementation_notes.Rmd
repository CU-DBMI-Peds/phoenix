...
5. Select PFR _or_ SFR to score:
   ...
   c. If at time t, SFR and PFR are both defined, then:
...
table) explain why PFR, SFR, or neither is used.

 | Minute | FiO~2~ Observed  | FiO~2~ | PaO~2~ Observed  | PAO2 | SPO2 Observed  | SPO2 | PFR    | SFR    | Notes |
 | --:    | --:              | --:    | --:              | --:  | --:            | --:  | --:    | --:    | :--   |
 | 34     |                  |        |                  |      | 100            | 100  |        |        | 1.    |
 | 69     |                  |        |                  |      |                | 100  |        |        | 1.    |
 | 94     | 1                | 1      |                  |      | 99             | 99   |        |        | 2.    |
...
1. No PFR or SFR because there is no FiO~2~
2. SpO~2~ is greater than 97 and thus not to be used.  There is no SFR at this time.
3. SpO~2~ is greater than 97 and thus not to be used.  PaO~2~ observed and is younger than FiO~2~.  Use PFR.
4. SpO~2~ is &leq; 97; can be used for SFR.  SpO~2~ is younger than FiO~2~.  SFR is younger than PFR.  Use SFR.
...
8. SpO~2~ &gt; 97; do not calculate SFR.  PaO~2~ is _younger_ than FiO~2~: calculate PFR and use it.
9. SpO~2~ &leq; 97 and younger than FiO~2~; calculate SFR;  PaO~2~ is _older_ than FiO~2~: do not calculate PFR.  Use SFR.

## Scoring
Scoring is based on PFR _or_ SFR.  The Respiratory scores are
...
# approach has not been implemented on the main branch of the project yet.
