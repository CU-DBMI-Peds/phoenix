...
- [General Data Formatting Notes](#general-data-formatting-notes)
- [Inclusion/Exclusion criteria](#inclusionexclusion-criteria)
- [Suspected Infection](#suspected-infection)
- [General notes for all subscores](#general-notes-for-all-subscores)
...
* Patients with a gestational age less than 37 weeks at the time of admission
* Patients older than 18 years of age (216 months)
...
Reasonable values for observations and labs used during development of the Phoenix Sepsis Score are documented here: https://github.com/CU-DBMI-Peds/phoenix_sepsis_criteria/blob/main/harmonization/standard_names_and_units.csv
...
* Units: none
* Expected Values: 0, 1, 2, 3, etc. (maximum vasoactive points is reached with 2)
* Caveats: see above
* Look back: 12 hours
...
MAP can be calculated as `(2/3) * DBP + (1/3) * SBP`
...
* MAP:
  ...
  * Caveats:
    * If MAP is provided along with SBP and DBP it is worth verifying that DBP ≤ MAP ≤ SBP
  * Look back: 6 hours
...
* SBP:
  ...
  * Expected Values: [1, 300]
  * Caveats:
    * It is worth verifying that DBP ≤ SBP, we used a slightly more
