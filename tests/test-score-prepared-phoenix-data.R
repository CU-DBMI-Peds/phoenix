...
assert_end_to_end <- function(backend) {
  ...
  stopifnot(
    ...
    isTRUE(all.equal(olm[["sepsis_olm"]][1], 1)),
    isTRUE(all.equal(olm[["septic_shock_olm"]][1], 1)),
    isTRUE(all.equal(olm[["odss_8_olm"]][1], 9)),
    isTRUE(all.equal(olm[["pss_8_olm"]][1], 9)),
    isTRUE(all.equal(olm[["odss_4_olm"]][2], 1)),
    isTRUE(all.equal(olm[["pss_4_olm"]][2], 0)),
    isTRUE(all.equal(olm[["sepsis_olm"]][2], 0)),
    isTRUE(all.equal(olm[["septic_shock_olm"]][2], 0)),
    isTRUE(all.equal(olm[["odss_8_olm"]][2], 1)),
    isTRUE(all.equal(olm[["pss_8_olm"]][2], 0)),
    isTRUE(all.equal(ccd[["odss_4_ccd"]][1], 5)),
    isTRUE(all.equal(ccd[["pss_4_ccd"]][1], 5)),
    isTRUE(all.equal(ccd[["sepsis_ccd"]][1], 1)),
    isTRUE(all.equal(ccd[["septic_shock_ccd"]][1], 1)),
    isTRUE(all.equal(ccd[["odss_8_ccd"]][1], 9)),
    isTRUE(all.equal(ccd[["pss_8_ccd"]][1], 9)),
    isTRUE(all.equal(ccd[["odss_4_ccd"]][2], 1)),
    isTRUE(all.equal(ccd[["pss_4_ccd"]][2], 0)),
    isTRUE(all.equal(ccd[["sepsis_ccd"]][2], 0)),
    isTRUE(all.equal(ccd[["septic_shock_ccd"]][2], 0)),
    isTRUE(all.equal(ccd[["odss_8_ccd"]][2], 1)),
    isTRUE(all.equal(ccd[["pss_8_ccd"]][2], 0)),
    isTRUE(all.equal(fcd[["odss_4_fcd"]][1], 5)),
    isTRUE(all.equal(fcd[["pss_4_fcd"]][1], 5)),
    isTRUE(all.equal(fcd[["sepsis_fcd"]][1], 1)),
    isTRUE(all.equal(fcd[["septic_shock_fcd"]][1], 1)),
    isTRUE(all.equal(fcd[["odss_8_fcd"]][1], 9)),
    isTRUE(all.equal(fcd[["pss_8_fcd"]][1], 9)),
    isTRUE(all.equal(fcd[["odss_4_fcd"]][2], 1)),
    isTRUE(all.equal(fcd[["pss_4_fcd"]][2], 0)),
    isTRUE(all.equal(fcd[["sepsis_fcd"]][2], 0)),
